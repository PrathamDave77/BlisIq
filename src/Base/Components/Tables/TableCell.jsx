...
const TableCell = ({ variant, isdefault, istableaction, email, username, isAvatar, isAvatarGrp, isFile, isPayment, isBadge, istrend, amount, credentials, isAction, children }) => {
    return (
