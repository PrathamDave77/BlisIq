...
import File_icons from "/File_icons.png";
...
const TableCell = ({
  ...
  return (
    <div className={cn(actions({}))}>
      ...
      {istableaction ? (
        <>
          <TableCellActions Radio={false} Toggle="Toggle" isToggle={false} />
          {children}
        </>
      ) : (
        children
        ...
        <div id="Avatar-Label-Group" className="flex items-center gap-lg font-family-body self-stretch leading-sm text-sm">
          ...
          {isFile && (
            <div className="flex items-center gap-2">
              <img src={File_icons} alt="File Icon" />
            </div>
          )}
          ...
          {credentials && (
            <div className="flex flex-col text-left">
              <div className="line-clamp-1 text-text-primary font-semibold">{username}</div>
              <div className="line-clamp-1 overflow-ellipsis text-text-tertiary">{email}</div>
            </div>
          )}
        </div>
      )}
      ...
      {/* Dropdown Icon */}
      {isdropdown && (
        <div className="py-[3.33px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="4" height="15" viewBox="0 0 4 15" fill="none">
            <path d="M1.66671 8.33331C2.12694 8.33331 2.50004 7.96022 2.50004 7.49998C2.50004 7.03974 2.12694 6.66665 1.66671 6.66665C1.20647 6.66665 0.833374 7.03974 0.833374 7.49998C0.833374 7.96022 1.20647 8.33331 1.66671 8.33331Z" stroke="#A4A7AE" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M1.66671 2.49998C2.12694 2.49998 2.50004 2.12688 2.50004 1.66665C2.50004 1.20641 2.12694 0.833313 1.66671 0.833313C1.20647 0.833313 0.833374 1.20641 0.833374 1.66665C0.833374 2.12688 1.20647 2.49998 1.66671 2.49998Z" stroke="#A4A7AE" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M1.66671 14.1666C2.12694 14.1666 2.50004 13.7935 2.50004 13.3333C2.50004 12.8731 2.12694 12.5 1.66671 12.5C1.20647 12.5 0.833374 12.8731 0.833374 13.3333C0.833374 13.7935 1.20647 14.1666 1.66671 14.1666Z" stroke="#A4A7AE" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      )}
    </div>
