    ...
    const actions = cva(
        `inline-flex items-center w-full gap-lg py-lg px-xl border-b-[1px] border-b-border-secondary bg-bg-primary text-text-tertiary text-center font-family-body text-sm leading-sm`,
        {
            variants: {
                variant: {
        ...
        return (
            <div className={cn(actions({}))}>
                ...
                {isAvatar && <div id="Avatar-Label-Group" className="flex items-center gap-lg font-family-body self-stretch leading-sm text-sm ">
                    ...
                    {credentials && <div className="flex flex-col items-start">
