...
const buttonVariants = cva(
    "inline-flex justify-center cursor-pointer items-center rounded-md transition-all duration-200 font-semibold leading-sm font-family-body bg-bg-primary",
    {
        variants: {
            ...
            variant: {
                primary:`border-[2px] border-[#FFF] text-[var(--color-text-white)] shadow-[var(--shadow-xs-skeumorphic)]  disabled:border-px disabled:border-[var(--border-disabled-subtle)] disabled:shadow-[var(--color-shadow-xs)] bg-[var(--bg-brand-solid)] hover:bg-[var(--bg-brand-solid-hover)] focus-visible:shadow-[var(--focus-ring-shadow-xs-skeumorphic)] `,
                secondary:` border border-border-primary text-text-secondary  shadow-[var(--shadow-xs-skeumorphic)]  focus-visible:shadow-[var(--focus-ring-shadow-xs-skeumorphic)] disabled:border-[var(--border-disabled-subtle)] disabled:shadow-xs disabled:text-fg-disabled border-border-primary text-text-secondary hover:bg-bg-primary-hover text-text-error
                `,
                tertiary:`  text-text-tertiary text-sm hover:bg-bg-primary-hover hover:text-text-tertiary-hover focus-visible:bg-[#FFF] focus-visible:shadow-[var(--focus-ring)] disabled:text-fg-disabled disabled:bg-bg-primary-hover`,
...
const Button = forwardRef(
    ...
    ({children,variant,size,isError,...props},ref) => {
