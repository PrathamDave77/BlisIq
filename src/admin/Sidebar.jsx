...
const Sidebar = () => {
  ...
  return (
    <div className=" font-inter flex flex-col bg-bg-primary rounded-none space-non w-[284px] justify-between">
      <div id="profile" className="flex flex-col gap-4xl pt-2xl text-text-secondary w-full">
        <div className='flex justify-between py-none px-2xl items-center self-stetch'>
          <div id="title" className="flex flex-row items-center gap-sm">
            ...
            <span className="font-semibold text-lg">BlissIQ</span>
          </div>
          <span className="text-text-quaternary text-sm  font-semibold leading-sm">
            v3.0
          </span>
        </div>
        <div className="flex flex-col items-start self-stretch w-full">
          <div className="flex pr-2xl pb-xs pl-2xl font-semibold text-xs text-text-quaternary w-full leading-xs">
            GENERAL
          </div>
          ...
          <div className="flex pt-0 pr-2xl pl-2xl pb-xs self-stretch items-start font-inter font-semibold leading-xs text-xs text-text-quaternary">USERS</div>
          <div className="flex flex-col pt-0 pl-xl pr-xl pb-2xl w-full">
            {Users.map((item, index) => (
              <button key={index} className="flex pt-xxs pb-xxs gap-2 items-center cursor-pointer hover:bg-bg-primary-hover w-full">
                <div className="flex flex-row rounded-sm pt-md pr-lg pb-md pl-lg gap-lg items-center self-stretch">
                  <span>{item.icon}</span>
                  <span className="text-text-secondary  font-semibold text-md">{item.desc}</span>
                </div>
              </button>
            ))}
          </div>
      ...
      <div id="settings" className="flex flex-col pt-0 pl-xl pr-xl pb-xl gap-xl items-start self-stretch">
        <div className="flex flex-col">
          <div className="flex flex-col pt-xxs pb-xxs pl-0 pr-0 items-start self-stretch gap-2">
            <button className="flex pt-md pb-md pl-lg pr-lg items-center gap-sm self-stretch text-text-secondary cursor-pointer w-full flex-row rounded-sm  font-semibold text-md leading-md">
        ...
        <div className="flex rounded-md items-center gap-xxs bg-bg-secondary text-text-secondary border border-border-secondary self-stretch">
          <button className="flex flex-1 px-lg py-md items-center justify-center cursor-pointer bg-bg-primary  text-text-secondary leading-sm rounded-md gap-md border border-border-secondary shadow-shadow-xs self-stretch font-semibold" onClick={() => document.documentElement.classList.remove("theme-dark")}>
          ...
          <button className="flex flex-1 items-center justify-center px-lg py-md cursor-pointer rounded-md gap-md radius-md border-border-secondary shadow-shadow-xs self-stretch font-semibold" onClick={() => document.documentElement.classList.add('theme-dark')}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <div className="flex p-lg gap-xl self-stretch border border-border-secondary bg-bg-primary rounded-xl justify-between">
          <div className="flex flex-row gap-md">
            <div className="flex justify-center items-center rounded-full ">
              <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="rounded-full">
                <path
            ...
            <div className="flex flex-col justify-between">
              <div className="self-stretch text-text-primary  text-sm font-semibold leading-sm ">Jacob Jones</div>
              <div className="text-sm font-normal leading-sm text-text-tertiary">jacob@diacto.com</div>
            </div>
          </div>
