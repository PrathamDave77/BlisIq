...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col bg-primary radius-none space-non w-[284px] justify-between">
          ...
          <div className="flex flex-col pr-xl pb-2xl pl-xl pt-0">
            {general.map((item, index) => (
              <div key={index} className="flex pt-xxs pb-xxs gap-2 ">
                <div className="flex flex-row radius-sm pt-md pr-lg pb-md pl-lg gap-lg items-center self-stretch">
                  <span>{item.icon}</span>
      ...
      <div id="settings" className="flex flex-col pt-0 pl-xl pr-xl pb-xl gap-xl items-start self-stretch">
        <div className="flex flex-col pt-xxs pb-xxs pl-0 pr-0 items-start self-stretch gap-2">
          <button className="flex pt-md pb-md pl-lg pr-lg items-center self-stretch gap-lg">
        ...
        <div className="flex radius-md border gap-xxs bg-bg-secondary items-center">
